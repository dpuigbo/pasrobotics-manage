...
use App\Filament\Resources\ControllerModelResource\RelationManagers;
...
class ControllerModelResource extends Resource
{
    ...
    {
        return [
            'index'  => Pages\ListControllerModels::route('/'),
            'create' => Pages\CreateControllerModel::route('/create'),
            'edit'   => Pages\EditControllerModel::route('/{record}/edit'),
        ];
    }
}
